                ...
                load ?
                    <div className="d-flex justify-content-center">
                        <div className="table-container" style={{ minWidth: '80%' }}>
                            <div className="row">
                                <div className="col">
                                    <h5 className="pb-2 mb-0">Danh sách danh mục sản phẩm</h5>
                                </div>
                                ...
                                <table className="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" className="col-1">Chức năng</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {list.map((item) => (
                                            <tr key={item.id}>
                                                ...
                                                <td style={{ whiteSpace: 'nowrap' }}>
                                                    ...
                                                    <button type="button" id={item.id} title={item.name}
                                                        ...
                                                        className="btn btn-outline-danger btn-light btn-sm mx-sm-1 px-lg-2 w-32"><i
